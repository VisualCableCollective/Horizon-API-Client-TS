...
// Models
var ROUTE_ID_REPLACE_PLACEHOLDER = '{id}'; // AUTH

var USER_CREDENTIALS_LOGIN_ROUTE = {
  route: 'oauth/token',
  method: RequestMethod.POST,
  requiresAuth: false,
  requiresID: false,
  requiresParentRoute: false,
  disableApiUrlPrefix: true
};
var GET_SELF_USER_DATA_ROUTE = {
  route: 'user/me',
  method: RequestMethod.GET,
  requiresAuth: true,
  requiresID: false,
  requiresParentRoute: false,
  disableApiUrlPrefix: false
};
var GET_TEAM_ROUTE = {
  route: 'store/teams/{id}/',
  method: RequestMethod.GET,
  requiresAuth: false,
  requiresID: true,
  requiresParentRoute: false,
...
(function (LoginStatus) {
  ...
  LoginStatus[LoginStatus["Success"] = 1] = "Success";
  LoginStatus[LoginStatus["UnknownError"] = 2] = "UnknownError";
  LoginStatus[LoginStatus["CredentialsInvalid"] = 3] = "CredentialsInvalid";
})(LoginStatus || (LoginStatus = {}));

var TokenResponse = function TokenResponse(jsonData) {
...
var Team = function Team(apiTeamResponse) {
  var _this = this;
...
var HTTPRequestUtil = /*#__PURE__*/function () {
  function HTTPRequestUtil(config) {
  ...
  var _proto = HTTPRequestUtil.prototype;

  _proto.Request = /*#__PURE__*/function () {
    var _Request = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(route, data) {
      var routeCopy, headers, options, params, serverUrl, response;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 12:
              ...
              _context.prev = 20;
              _context.next = 23;
              return fetch(serverUrl + routeCopy.route + params, options);
            ...
            case 27:
              ...
              console.error("Error (url: " + (serverUrl + routeCopy.route + params) + ") " + _context.t0);
              return _context.abrupt("return", null);
...
var HorizonAPIClient = /*#__PURE__*/function () {
  function HorizonAPIClient(config) {
    this.Config = config;
  ...
  var _proto = HorizonAPIClient.prototype;

  _proto.authenticateUserWithToken =
  /*#__PURE__*/
  function () {
    var _authenticateUserWithToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(token) {
      var response;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
    ...
    function authenticateUserWithToken(_x) {
      return _authenticateUserWithToken.apply(this, arguments);
    }

    return authenticateUserWithToken;
  }()
  /**
   * Authenticates a user with the given token.
   * @param token Bearer token to authenticate a user
  ...
  _proto.authenticateUserWithCredentials =
  /*#__PURE__*/
  function () {
    var _authenticateUserWithCredentials = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(username, password) {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.RequestService.Request(USER_CREDENTIALS_LOGIN_ROUTE, {
                grant_type: 'password',
            ...
            case 5:
              ...
              return _context2.abrupt("return", {
                status: LoginStatus.CredentialsInvalid
              });

            case 7:
              _context2.t0 = TokenResponse;
              _context2.next = 10;
              return response.json();

            case 10:
              _context2.t1 = _context2.sent;
              tokenData = new _context2.t0(_context2.t1);
              return _context2.abrupt("return", {
    ...
    function authenticateUserWithCredentials(_x2, _x3) {
      return _authenticateUserWithCredentials.apply(this, arguments);
    }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              getTeamRouteCopy = GET_TEAM_ROUTE;
...
export { Environment, HorizonAPIClient, HorizonAPIClientConfig, LoginStatus, Product, SelfUser, Team };
//# sourceMappingURL=horizon-api-client.esm.js.map
